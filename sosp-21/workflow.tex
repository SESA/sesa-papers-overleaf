...
\subsubsection{Impact of OS path length and IPC}
...
\em{Core Finding: There is no clear winner on how to behave but there is OS behaviours that can be used to adapt to through a combination of slowing down processing and delaying interrupts.   Further specializing the OS for running a single network driven service on a node magnifies the benefits}
