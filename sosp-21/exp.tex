...
In our experiments, we use the RAPL model specific registers (MSR)
to explicitely set power limits
up to a default maximum of \texttt{135} Watts (\watt)
in a single package on our 2-package processor. After some initial experimentation, we
found that our workloads continue to execute correctly at a minimum RAPL limiting value of around \texttt{55} \watt.
